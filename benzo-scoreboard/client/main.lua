...
local function Menu()
    ...
    local Elements = {{
        ...
        title = "Elérhető játékosok: " .. PlayerCount .. "/" ..ServerSlots
    }}
                ...
                if element.value == "player" then
                    ...
                    if Config.ShowName then 
                        Options[#Options + 1] = {
                            ...
                            title = "Karakternév: " .. SelectedPlayer.Name
                        }
                    end
                    if Config.ShowHealth then 
                        Options[#Options + 1] = {
                            icon = "fa-solid fa-signature",
                            title = "Életerő: " .. PlayerHealth .. "%"
                        }
                    end
                    if Config.ShowArmour then 
                        Options[#Options + 1] = {
                            icon = "fa-solid fa-signature",
                            title = "Pajzs: " .. PlayerArmour .. "%"
                        }
                    end
                    ...
                    if Config.ShowJob then 
                        Options[#Options + 1] = {
                            ...
                            title = "Állás: " .. SelectedPlayer.Job,
                    ...
                    if Config.ShowGroup then 
                        ...
                        title = "Admingroup: " .. SelectedPlayer.Group,
                        }
                    end
                    Options[#Options + 1] = {
